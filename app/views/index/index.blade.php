	...
	<div class="wrapper">		
		...
		<div role="main" class="main">
            ...
            <div>
                ...
                <img src="/img/slider/any6.jpg" style="height:300px; border-radius: 5px;" align="left" alt="" />

                <div class="notice-area-blue margin-bottom-large margin-left-large" style="width:377px; display: inline-block;">

                    <span style="font-weight:bold; margin-right:5px;">Proverbs 22:6</span><span style="font-style:italic">(New King James Version)</span><br />
            ...
            <div class="clear"></div><br>
                ...
                <div id='homepage-content'>
                    ...
                    <h2 class="homepage-section">What We Do</h2>
                    ...
                    <h2 class="homepage-section">Hours</h2>
        	...
        	<div >	
                ...
                <div class="slider-wrapper theme-default">
                    ...
                    <div id="slider" class="nivoSlider">
                        ...
                        <img src="/img/slider/any6.jpg" height="250" alt="" />
            ...
            <!--<div>
            	...
            	<div class="sub-image">
            		...
            		<img src="http://placeimg.com/300/300/any" width="100%" />

                </div>

                <div class="sub-image">

            		<img src="http://placeimg.com/400/400/any" width="100%" />

                </div>

                <div class="sub-image">

            		<img src="http://placeimg.com/500/500/any" width="100%" />
